                ...
                <div class="row m-l-0 m-r-0">
                    <div class="col-sm-4 bg-c-lite-green user-profile">
                        <div class="card-block text-center text-white">
                            <div class="m-b-25"> <img src="<?php echo e(asset('images/user-profile.png')); ?>" class="img-radius" alt="User-Profile-Image"> </div>
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <a href="<?php echo e(route('account.changePassword')); ?>" class="btn primary-outline-btn">Change password</a>
                                </div>
                                <div class="col-sm-6">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\joblister-laravel-8\resources\views/account/user-account.blade.php ENDPATH**/ ?>