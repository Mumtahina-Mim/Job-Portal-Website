        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            ...
            <div class="footer-link-list">
             <a href="<?php echo e(route('register')); ?>" class="footer-links">Register <span class="badge badge-primary">Free</span></a>
             <a href="<?php echo e(route('login')); ?>" class="footer-links">Login</a>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            ...
            <div class="footer-link-list">
             <a href="<?php echo e(route('register')); ?>" class="footer-links">Register <span class="badge badge-primary">Free</span></a>
             <a href="<?php echo e(route('login')); ?>" class="footer-links">Login</a>
             <a href="<?php echo e(route('post.create')); ?>" class="footer-links">Vacancy Announcement</a>
             <a href="#" class="footer-links">Faq</a>
            </div>
          </div>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\joblister-laravel-8\resources\views/inc/footer.blade.php ENDPATH**/ ?>