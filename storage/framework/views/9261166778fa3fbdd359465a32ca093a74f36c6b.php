<?php /* /Applications/XAMPP/xamppfiles/htdocs/larajob/resources/views/jobs/create.blade.php */ ?>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <input type="text" id="datepicker"  name="last_date" class="form-control <?php echo e($errors->has('last_date') ? ' is-invalid' : ''); ?>"  value="<?php echo e(old('last_date')); ?>">
