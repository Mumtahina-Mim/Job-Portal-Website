        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="<?php echo e(asset('images/logo/joblister.png')); ?>" width="50px;" alt=""> Create your free jobseeker account</h3>
                ...
                <div class="login-form">
                    <form action="<?php echo e(route('register')); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="name" placeholder="Full name" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="password_confirmation" type="password" placeholder="Password(Repeat)" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" required>
...
.login-poster {
    /* fallback */
   background-image: url('<?php echo e(asset("images/login-background.png")); ?>');
    background-image: linear-gradient(
            to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)
        ),
        url('<?php echo e(asset("images/login-background.png")); ?>');
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\joblister-laravel-8\resources\views/auth/register.blade.php ENDPATH**/ ?>